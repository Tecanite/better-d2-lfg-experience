...
const dungeon_report_api_key = "2f4b6880fd6e47c89085cd8c9cd6c127"

/**
 * This function adds the sidebar div container to the dungeon.report page.
 * @author Tecanite
 * @name addSidebar
...
function addSidebar(profiles) {
    ...
    if (document.location.href == "https://dungeon.report/") {
...
async function getEmblemUrl(platform, id) {
    ...
    myInnerHeaders.append("x-api-key", dungeon_report_api_key);
